...
export const PRODUCTION_MACHINES: readonly ProductionMachine[] = [
  { basePowerMw: 4, id: "Build_ConstructorMk1_C", name: "Constructor" },
  { basePowerMw: 4, id: "Build_SmelterMk1_C", name: "Smelter" },
  { basePowerMw: 16, id: "Build_FoundryMk1_C", name: "Foundry" },
  { basePowerMw: 30, id: "Build_OilRefinery_C", name: "Refinery" },
  { basePowerMw: 10, id: "Build_Packager_C", name: "Packager" },
  {
    basePowerMw: 55,
    id: "Build_ManufacturerMk1_C",
    name: "Manufacturer",
  },
  { basePowerMw: 15, id: "Build_AssemblerMk1_C", name: "Assembler" },
  { basePowerMw: 75, id: "Build_Blender_C", name: "Blender" },
  {
    basePowerMw: 0,
    id: "Build_HadronCollider_C",
    name: "Particle Accelerator",
  },
  { basePowerMw: 0, id: "Build_Converter_C", name: "Converter" },
  {
    basePowerMw: 0,
...
export const LOGISTICS_BUILDABLES: readonly Buildable[] = [
  { id: "Build_ConveyorAttachmentMerger_C", name: "Conveyor Merger" },
  { id: "Build_ConveyorAttachmentSplitter_C", name: "Conveyor Splitter" },
  { id: "Build_PipelineJunction_Cross_C", name: "Pipeline Junction" },
  { id: "Build_PipelineJunction_T_C", name: "Pipeline T-Junction" },
  {
...
export const SPECIAL_BUILDABLES: readonly Buildable[] = [
  { id: "Build_ResourceSink_C", name: "AWESOME Sink" },
];
