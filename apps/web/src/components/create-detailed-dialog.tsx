        ...
        <form className="grid gap-4" onSubmit={(event) => void submit(event)}>
          ...
          >
            ...
            <p className="text-muted-foreground">
              ...
              Each connection uses the lowest tier that carries its flow. Each
              machine’s individual port must still fit the selected speed. These
              limits apply only to conversion. Afterwards, new links start at
              Mk.1 and you can choose any tier in the link inspector.
            </p>
          </fieldset>
          {error && (
